...
export const practices: Record<FlowType, PracticeCard[]> = {
  ...
  meditation: [
    { id: 'vagus', label: '4-7-8 Breathing', description: '4 seconds inhale, 7 hold, 8 exhale — nervous system ko turant calm karein.', icon: TbWind, theme: { dark: '#173D46', accent: '#36A6A0' }, videoId: '1yB6xLorpGGb_VKKCI-jO4LS_qgZz0Fg1' },
    ...
    { id: 'box', label: 'Box Breathing', description: 'Growing box ko follow karke breathing balance karein.', icon: TbBox, theme: { dark: '#173967', accent: '#488BD5' }, videoId: '1MGLk5_l2CUQpx87hii8C_yuqcTo-_I6F' }
  ],
  samadhan: [
